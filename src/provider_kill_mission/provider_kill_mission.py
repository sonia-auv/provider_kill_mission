...
from provider_kill_mission.srv import OverrideMissionSwitch, SetMissionSwitch, OverrideMissionSwitchResponse, SetMissionSwitchResponse
...
class ProviderKillMission:
    ...
    def __init__(self):
        ...
        rospy.service('/provider_kill_mission/override_mission_switch', OverrideMissionSwitch, self._override_mission_switch_callback)
